...
function Model(props) {
  ...
  useEffect(() => {
    Object.entries(materials)?.map((elem) => {
      if (
        elem[0] !== "zFdeDaGNRwzccye" &&
        elem[0] !== "ujsvqBWRMnqdwPx" &&
        elem[0] !== "hUlRcbieVuIiOXG" &&
        elem[0] !== "jlzuBkUzuJqgiAK" &&
        elem[0] !== "xNrofRCqOXXHVZt"
      ) {
        elem[1].color = new THREE.Color(props.item.color[0]);
      }
      elem[1].needsUpdate = true;
    });
